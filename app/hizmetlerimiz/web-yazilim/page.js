...
const WebDevelopmentPage = () => (
  <div className="min-h-screen flex items-center justify-center bg-customGray text-white p-6">
    <div className="max-w-4xl w-full mx-auto p-6 bg-customGray text-white rounded-lg shadow-md mt-10">
